...
Welcome to the Social Connect App documentation! This directory contains all project documentation organized by category.
...
This documentation is maintained alongside code changes. If you make significant changes to the codebase:
...
**Need help?** Check the main [README.md](../README.md) in the project root.
